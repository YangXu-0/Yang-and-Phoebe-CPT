...
def movement_boundaries(position, boundary_values, radius):
    ...
    try:
        ...
        raise Exception("position should be a list containing 2 ints/floats." +
                        " boundary_values should be a list containing 3 " +
                        " ints/floats. radius should be an int/float value.")
...
class Enemy:
    ...
    def patch(self):
        ...
        enemy_dialogue = ["Patch blocks the way!",
                          ...
                          "Patch smiles at you",
                          "Patch laughs and his arrogant vibe dissolves" +
                          " into a friendly aura."]
    ...
    def quack(self):
        ...
        enemy_dialogue = ["Quack blocks the way!",
                          ...
                          "Quack growls at you", "Quack laughs at your " +
                          "defiant attitude",
    ...
    def desdemona(self):
        ...
        enemy_dialogue = ["Desdemona blocks the way!",
                          ...
                          "You are ignored", "She glares at you, " +
                          "the insult hits a sore spot",
                          "Desdemona's confidence goes down",
                          "Desdemona is getting scared",
    ...
    def gallo(self):
        global enemy_dialogue, attack_functions, enemy_image
        enemy_dialogue = ["Gallo blocks the way!",
    ...
    def attack(self):
        ...
        try:
            ...
            raise Exception("obstacle_pos needs to be a list containing" +
                            " ints or floats of at least 2 corners of" +
                            " an obstacle.")
        ...
        for coordinate in range(0, len(self.obstacle_pos), 4):
            try:
                (player_pos[0] + radius >=
                 ...
                 player_pos[0] - radius <=
                 self.obstacle_pos[coordinate + 2] and
                 player_pos[1] + radius >=
                 self.obstacle_pos[coordinate + 1] and
                 player_pos[1] - radius <=
                 self.obstacle_pos[coordinate + 3] and
                 self.collision_immune) is False
            except:
    ...
    def use_item(self, item_index, list_items, list_item_values):
        try:
            ...
            raise Exception("item_index needs to be an int smaller than" +
                            " the length of list_item_values " +
                            "(needs to be list)")
...
class Tests():
    ...
    def test_enemy_rosalind(self):
        ...
        assert enemy_dialogue == ["Rosalind stumbles in the way.",
                                  ...
                                  "Rosalind cries out, still frightened",
                                  "Rosalind sniffs and wipes away her tears.",
                                  "Rosaline finally cracks a smile, " +
    ...
    def test_enemy_quack(self):
        ...
        assert test_enemy_class.act_choices == ["Taunt", "Ignore", "Joke",
                                                "Pet"],\
            "Should be given actions user can do against Quack and " +
        "solution to problem"
    ...
    def test_enemy_desdemona(self):
        ...
        assert enemy_dialogue == ["Desdemona blocks the way!",
                                  "Desmonda files her nails",
                                  "You are ignored",
                                  "She glares at you, the insult hits" +
                                  " a sore spot",
                                  "Desdemona's confidence goes down",
                                  "Desdemona is getting scared",
                                  "Desdemona cowers in fright."],\
